import java.awt.*;
import javax.swing.*;
public class CShapes1 extends JFrame
{
	public void paint(Graphics g)
	{
		//Below two lines create a line in green color...
		g.setColor(Color.GREEN);
		g.drawLine(5,30,350,360);
		//Below three line create 2 rectangles side by side one with blue border and other is filled by blue color...	g.setColor(Color.BLUE);
		...
		//Below two lines will draw oval shape with color magenta...
